...
DAYS_NO_CONNECTIVITY_MAX = 36500     # do not allow to engage after this many days - disable connect warning
DAYS_NO_CONNECTIVITY_PROMPT = 36500  # send an offroad prompt after this many days - disable connect warning

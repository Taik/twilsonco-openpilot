...
procs = [
  ...
  PythonProcess("live_map_data_sp", "selfdrive.sunnypilot.live_map_data_sp", only_onroad),
  PythonProcess("otisserv", "selfdrive.navd.otisserv", always_run),
  PythonProcess("fleet_manager", "system.fleetmanager.fleet_manager", only_offroad, sigkill=True),

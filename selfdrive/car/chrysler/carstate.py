...
class CarState(CarStateBase):
  def __init__(self, CP):
    ...
    self.lkas_button = None
    self.lkas_disabled = 0
  ...
  def update(self, cp, cp_cam):
    ...
    if self.CP.carFingerprint in RAM_CARS:
      ...
      if self.lkas_button == 1 and self.lkas_disabled == 0 and self.lkas_button_prev == 0:
        self.lkas_disabled = 1
      elif self.lkas_button == 1 and self.lkas_disabled == 1 and self.lkas_button_prev == 0:
        self.lkas_disabled = 0
